...
export function MemberHomePage() {
  ...
  const renderSurface = () => {
    ...
    return <aside className={`member-command-surface ${surface}`}>
      ...
      {surface === "updates" && <><span>GÜNCELLEME NOTLARI</span><h2>SW Identity v{SW_IDENTITY_VERSION}</h2><article><b><i /> Güvenli işlem doğrulaması</b><p>Önemli hesap işlemleri Authenticator veya e-posta koduyla korunuyor.</p></article><article><b><i /> Destek posta köprüsü</b><p>E-posta yanıtları imzalı veri akışıyla doğru destek talebine ulaşıyor.</p></article><article><b><i /> Cihaz ve platform ağı</b><p>Haritalı oturum görünümü ve bağlı SW/Google/Kick hesapları tek merkezde.</p></article></>}
  ...
  return <main className="member-shell member-home-shell">
    ...
    <section className="member-content member-home-content"><div className="member-welcome"><p>{t.home} · SW IDENTITY BAĞLI</p><h1>{t.hello},<br />{displayName.toLocaleUpperCase(locale === "tr" ? "tr-TR" : "en-US")}.</h1></div><div className="member-dashboard">
      ...
      <section className="member-whats-new"><div><span>SW SİNYALİ / v{SW_IDENTITY_VERSION}</span><h2>{t.news}</h2><p>SW Identity önemli hesap işlemlerini Authenticator veya e-posta koduyla doğruluyor; destek e-postaları da imzalı veri akışıyla hesabına bağlanıyor.</p></div><div className="member-release-list"><article><b>01</b><span>Güvenli işlem onayı<small>E-posta, şifre ve hesap silme adımları güçlü doğrulamadan geçer.</small></span></article><article><b>02</b><span>Destek posta köprüsü<small>Destek yanıtları e-postadan doğru konuşmaya güvenle ulaşır.</small></span></article><article><b>03</b><span>Cihaz ve platform ağı<small>Haritalı oturumlar ile SW, Google ve Kick bağlantıları tek merkezde.</small></span></article></div></section>
