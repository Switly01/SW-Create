...
function KickMark() {
  return <img src="/brand/kick-logo.svg" alt="" aria-hidden="true" />;
}
      ...
      <div className="auth-box">
        ...
        <form className="auth-form profile-form" onSubmit={submit}>
          ...
          <div className="social-auth social-auth-icons" aria-label="Hesap sağlayıcısı">
            {mode === "login" && <button type="button" className="social-auth-button sw" title="SW Identity ile devam et" aria-label="SW Identity ile devam et" aria-expanded={nativeInfoOpen} onClick={() => {
