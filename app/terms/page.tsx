...
export default function TermsPage() {
  return (
    <main className="legal-page">
      <Link className="brand" href="/"><span className="brand-mark"><Image src="/brand/swcreate-logo.png" alt="" width={42} height={42} /></span>SW CREATE</Link>
      <article className="legal-content">
        <p className="section-number">YASAL</p>
        <h1>KULLANIM<br />KOŞULLARI.</h1>
        <p>Son güncelleme: 14 Ağustos 2026</p>
        <h2>Hizmet kapsamı</h2><p>SW Create, ürün kataloğu, merkezî hesap ve ürün erişimi sağlar. Deneme veya erken erişim özellikleri değişebilir.</p>
        ...
        <h2>Üyelikler</h2><p>Ücretsiz, Ürün Pro ve SW Create Özel planları gösterilebilir. Ödeme sistemi etkinleştirilene kadar ücretli plan düğmeleri yalnızca erken erişim listesine kayıt sağlar.</p>
